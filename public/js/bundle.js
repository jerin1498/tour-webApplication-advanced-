        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              // getting data form our api that we created
              method: 'POST',
              url: '/api/v1/users/login',
              // only work if they are hosted in same platform or else you should type the full url link like this http://127.0.0.1:3000/api/v1/users/login
              data: {
                email: email,
                password: password
              }
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              // status is that we provided in our api
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error during logging out! Try again');
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // adding marker

    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // adding popup message
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = type === 'data' ? baseUrl + 'updateme' : baseUrl + 'updatepassword';
            _context.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "user ".concat(type, " updated successfully"));
              window.setTimeout(function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _context.next = 6;
            return (0, _stripeJs.loadStripe)('pk_test_k4bQtG1YigHSNqVBPbbkdfot005EIfpZTF');
...
var bookBtn = document.querySelector('#book-tour'); // for displaying map
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); // updating user detail

if (updateForm) {
  updateForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(); // it include multipart method init by this only we can send files
...
if (alertMessage) (0, _alert.showAlerts)('success', alertMessage, 7);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "6232" + '/');
